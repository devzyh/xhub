<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="访问密码" prop="shareSecret">
        <el-input
          v-model="queryParams.shareSecret"
          placeholder="请输入访问密码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="分享天数" prop="shareDays">
        <el-input
          v-model="queryParams.shareDays"
          placeholder="请输入分享天数"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['notebook:share:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="访问密码" prop="shareSecret">
          <el-input v-model="form.shareSecret" placeholder="请输入访问密码" />
        </el-form-item>
        <el-form-item label="分享天数" prop="shareDays">
          <el-input v-model="form.shareDays" placeholder="请输入分享天数" />
        </el-form-item>
...
<script>
import { listShare, getShare, delShare, addShare, updateShare } from "@/api/notebook/share";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getShare(contentId).then(response => {
