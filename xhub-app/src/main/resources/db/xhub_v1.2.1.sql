...
INSERT INTO `fav_article` VALUES (50, '秒懂 23 种设计模式！有点污，但真得秒啊...', 'https://mp.weixin.qq.com/s/U3LWho3pGw6PdLdsO51kjg', '', 'wxmp', '2022-04-29');
...
INSERT INTO `fav_article` VALUES (74, '踩坑了！0作为除数，不一定会抛出异常！', 'https://www.cnblogs.com/thisiswhy/p/16635585.html', '', 'cnblogs', '2022-08-29');
INSERT INTO `fav_article` VALUES (75, '分布式和微服务的区别', 'https://www.cnblogs.com/wq-9/p/15183778.html', NULL, 'cnblogs', '2021-08-25');
INSERT INTO `fav_article` VALUES (76, '构建 Java 镜像的 10 个最佳实践', 'https://mp.weixin.qq.com/s/u4bsD_xgQ72BdcKNyU3xmw', '在下面的速查表中，我将为你提供构建生产级 Java 容器的最佳实践，旨在优化和保护要投入生产环境中的 Docker 镜像。', 'wxmp', '2022-09-07');
INSERT INTO `fav_article` VALUES (77, '简单几步，实现 Redis 查询 “附近的人”', 'https://mp.weixin.qq.com/s/1DzUZ7UskewntdygOksz5A', 'Redis结合其有序队列zset以及geohash编码，实现了空间搜索功能，且拥有极高的运行效率。', 'wxmp', '2022-09-15');
INSERT INTO `fav_article` VALUES (78, '接手了一座年收入 2000 万美元的“屎山”，我到底该重写还是跳槽？', 'https://mp.weixin.qq.com/s/q7tRnbnHVr3mM951ayny7A', '近日 Hacker News 上有一则帖子热度非常高，其主题是：我接手了一份极其糟糕的代码和一支技术团队，接下来该怎么办？', 'wxmp', '2022-09-26');
INSERT INTO `fav_article` VALUES (79, 'ByteMD开源编辑器', 'https://github.com/bytedance/bytemd', 'ByteMD是使用Svelte构建的标记编辑器组件。它也可以用于其他库/框架，如 React、Vue 和 Angular。', 'direct', '2022-09-27');
INSERT INTO `fav_article` VALUES (80, '理解和处理Cannot assign requested address错误', 'https://www.cnblogs.com/thatsit/p/cannot-assign-requested-address.html', '“Cannot assign requested address.”是由于linux分配的客户端连接端口用尽，无法建立socket连接所致，虽然socket正常关闭，但是端口不是立即释放，而是处于TIME_WAIT状态，默认等待60s后才释放。', 'cnblogs', '2020-07-21');
INSERT INTO `fav_article` VALUES (81, '淘宝开放平台应用技术规范', 'https://open.taobao.com/doc.htm?docId=109298&docType=1', '平台经过多年双11考验的技术架构经验向所有的生态伙伴输出，平台鼓励开放平台所有应用开发者依据此规范进行应用架构设计和优化，从而推动整个生态体系更加健康地发展。', 'direct', '2019-08-08');
INSERT INTO `fav_article` VALUES (82, 'MySQL分页延迟关联查询', 'https://www.cnblogs.com/pufeng/p/11750495.html', '下面的介绍均是在选用MySQL数据库和Innodb引擎的基础开展。我们先来学习索引的几个概念，帮助我们理解延迟关联优化的加快分页查询速度的原因。', 'cnblogs', '2019-10-28');
INSERT INTO `fav_article` VALUES (83, 'Java 动态代理的两种方式及其优缺点', 'https://mp.weixin.qq.com/s/kgB03P7Ocqj8EUTv55-zNw', '动态代理应用非常的广泛，在各种开源的框架中都能看到他们的身影，动态代理主要有JDK和CGLIB两种方式，今天来学习下这两种方式的实现，以及它们的优缺点。', 'wxmp', '2022-10-09');
INSERT INTO `fav_article` VALUES (84, 'NetHogs监控Linux的每个进程流量 ', 'http://bash.lutixia.cn/c/nethogs.html#nethogs', '有很多适用于Linux系统的开源网络监视工具。比如说，你可以用命令iftop来检查带宽使用情况。netstat用来查看接口统计报告，还有top监控系统当前运行进程。但是如果你想要找一个能够按进程实时统计网络带宽利用率的工具，那么NetHogs值得一看。', 'direct', '2022-10-09');
...
-- Records of fav_link
-- ----------------------------
INSERT INTO `fav_link` VALUES (1, 'editor', 'JSON编辑器', '/json', '简单的JSON文本编辑工具，可以对数据进行格式化和反格式化', NULL, 1, '_self', 19);
INSERT INTO `fav_link` VALUES (2, 'editor', 'XML编辑器', '/xml', '简单的XML美化压缩工具', NULL, 2, '_self', 1);
INSERT INTO `fav_link` VALUES (3, 'editor', '文本差异对比', '/diff', '对比两个文本的内容并高亮显示', NULL, 3, '_self', 4);
INSERT INTO `fav_link` VALUES (4, 'editor', 'XSLT测试', '/xslt', 'XML数据样式表功能测试', NULL, 4, '_self', 1);
INSERT INTO `fav_link` VALUES (5, 'editor', '加密解密', '/code', '支持常见的加密与解密技术', NULL, 5, '_self', 2);
INSERT INTO `fav_link` VALUES (6, 'helper', '腾讯翻译君', 'https://fanyi.qq.com/', '全新人工智能翻译， 句子、文章、论文、资料翻译首选', NULL, 1, '_blank', 2);
INSERT INTO `fav_link` VALUES (7, 'helper', '变量命名', 'https://unbug.github.io/codelf/', 'Codelf,变量命名,函数命名,方法命名,变量命名神器,GitHub 分组', NULL, 2, '_blank', 1);
INSERT INTO `fav_link` VALUES (8, 'helper', 'Github代下载', 'https://ghproxy.com/', 'GitHub 文件 , Releases , archive , gist , raw.githubusercontent.com 文件代理加速下载服务', NULL, 3, '_blank', 1);
INSERT INTO `fav_link` VALUES (9, 'helper', '项目文档工具', 'https://docsify.js.org/#/zh-cn/', '一个神奇的文档网站生成器', NULL, 4, '_blank', 1);
INSERT INTO `fav_link` VALUES (10, 'helper', 'IDEA试用', 'https://gitee.com/pengzhile/ide-eval-resetter', 'Jetbrains系列产品重置试用方法', NULL, 5, '_blank', 2);
INSERT INTO `fav_link` VALUES (11, 'helper', 'Git大全', 'https://gitee.com/all-about-git', '最全面的 Git 资源索引以及常用命令教程', NULL, 6, '_blank', 0);
INSERT INTO `fav_link` VALUES (12, 'helper', 'httpbin.org', 'https://httpbin.org', '一个简单的HTPP请求响应网站', NULL, 7, '_blank', 1);
INSERT INTO `fav_link` VALUES (13, 'document', 'Apache项目', 'https://www.apache.org/index.html#projects-list', 'Apache基金会官方项目列表', NULL, 1, '_blank', 5);
INSERT INTO `fav_link` VALUES (14, 'document', 'Java8文档', 'https://docs.oracle.com/javase/8/docs/api/', 'Java8官方文档', NULL, 2, '_blank', 1);
INSERT INTO `fav_link` VALUES (15, 'document', 'Spring文档', 'https://spring.io/projects', 'Spring项目官方文档', NULL, 3, '_blank', 1);
INSERT INTO `fav_link` VALUES (16, 'document', 'Mybatis文档', 'https://mybatis.org/mybatis-3/zh/index.html', 'Mybatis官方中文文档', NULL, 4, '_blank', 1);
INSERT INTO `fav_link` VALUES (17, 'document', 'Java开发手册', 'https://github.com/alibaba/p3c', '阿里巴巴Java开发手册', NULL, 5, '_blank', 0);
INSERT INTO `fav_link` VALUES (18, 'document', 'On Java8', 'https://gitee.com/lingcoder/OnJava8/tree/1ef7ec48e492862300e667e24c245e9b3a5ccd98', '《On Java 8》中文版', NULL, 6, '_blank', 1);
INSERT INTO `fav_link` VALUES (19, 'document', 'Java8特性', 'https://github.com/biezhi/learn-java8', '在这里你可以学习到 Java8 中的核心特性以及使用场景', NULL, 7, '_blank', 1);
INSERT INTO `fav_link` VALUES (20, 'document', 'Docs4dev', 'https://www.docs4dev.com/docs/zh', '开发文档中文版汇总', NULL, 8, '_blank', 2);
INSERT INTO `fav_link` VALUES (21, 'blog', '菜鸟教程', 'https://www.runoob.com', '提供了编程的基础技术教程, 介绍了各种编程语言的基础知识', NULL, 1, '_blank', 1);
INSERT INTO `fav_link` VALUES (22, 'blog', '阿里云藏经阁', 'https://developer.aliyun.com/ebook', '汇聚阿里巴巴技术实践精华，深度分享阿里工程师实战经验', NULL, 2, '_blank', 1);
INSERT INTO `fav_link` VALUES (23, 'blog', '程序员DD', 'https://blog.didispace.com/', '内容涵盖Java后端技术、微服务架构、运维开发等相关的研究与知识分享', NULL, 5, '_blank', 1);
INSERT INTO `fav_link` VALUES (24, 'blog', '酷壳博客', 'https://coolshell.cn/', '享受编程和技术所带来的快乐 – https://coolshell.cn', NULL, 7, '_blank', 1);
INSERT INTO `fav_link` VALUES (25, 'blog', '虫洞栈', 'https://bugstack.cn/', '重学Java设计模式, 字节码编程, 中间件, Spring, Java基础, 面经手册', NULL, 3, '_blank', 2);
...
INSERT INTO `fav_link` VALUES (30, 'editor', 'Cron表达式', '/cron', 'Crontab计划任务表达式在线生成', NULL, 6, '_self', 7);
...
INSERT INTO `fav_link` VALUES (39, 'editor', 'Diagram', 'https://app.diagrams.net/', '图表软件和流程图制作工具', NULL, 8, '_blank', 1);
INSERT INTO `fav_link` VALUES (41, 'helper', '程序员做饭指南', 'https://cook.aiurs.co/', '程序员在家做饭方法指南', NULL, 10, '_blank', 3);
...
INSERT INTO `fav_link` VALUES (48, 'blog', '并发编程网', 'http://ifeve.com/', '让天下没有难学的技术', NULL, 6, '_blank', 1);
INSERT INTO `fav_link` VALUES (49, 'blog', 'Java进阶知识', 'https://doocs.github.io/advanced-java/#/', '内容涵盖高并发、分布式、高可用、微服务、海量数据处理等', '', 10, '_blank', 0);
INSERT INTO `fav_link` VALUES (50, 'editor', 'Unix时间戳', '/unix', 'Unix时间戳在线转换工具', NULL, 7, '_self', 2);
...
INSERT INTO `fav_link` VALUES (53, 'document', 'OI Wiki', 'https://oi-wiki.org/', '一个免费开放且持续更新的编程竞赛知识整合站点', NULL, 9, '_blank', 1);
...
INSERT INTO `fav_link` VALUES (55, 'blog', 'Java全栈知识体系', 'https://pdai.tech/', '包含: Java, Spring, 数据库原理, 分布式, 中间件, 开发工具等', NULL, 4, '_blank', 2);
INSERT INTO `fav_link` VALUES (56, 'blog', 'Java项目《谷粒商城》', 'https://www.bilibili.com/video/BV1np4y1C7Yf', '微服务+分布式+全栈+集群+部署+自动化运维+可视化CICD', NULL, 14, '_blank', 0);
INSERT INTO `fav_link` VALUES (57, 'blog', '编程帮', 'http://www.biancheng.net/', '一个在线学习编程的网站，专注于分享优质编程教程', NULL, 15, '_blank', 0);
INSERT INTO `fav_link` VALUES (58, 'document', 'Redis 命令参考', 'http://doc.redisfans.com/', '本文档是 Redis Command Reference 和 Redis Documentation 的中文翻译版', NULL, 11, '_blank', 0);
INSERT INTO `fav_link` VALUES (59, 'helper', '代码在线高亮工具', 'https://highlightcode.com/', '将高亮美化的代码一键粘贴到Word或OneNote中。', NULL, 14, '_blank', 0);
...
-- ----------------------------
INSERT INTO `gen_table` VALUES (2, 'fav_tag', '文章标签表', NULL, NULL, 'FavTag', 'crud', 'cn.devzyh.xhub.favorite', 'favorite', 'tag', '文章标签', 'devzyh', '0', '/', '{\"parentMenuId\":2000}', 'admin', '2022-10-09 09:48:09', '', '2022-10-09 09:49:33', NULL);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (3, '2', 'id', 'ID', 'int(11)', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2022-10-09 09:48:09', '', '2022-10-09 09:49:33');
INSERT INTO `gen_table_column` VALUES (4, '2', 'tag_name', '标签名称', 'varchar(255)', 'String', 'tagName', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', 2, 'admin', '2022-10-09 09:48:10', '', '2022-10-09 09:49:33');
INSERT INTO `gen_table_column` VALUES (5, '2', 'tag_code', '标签代码', 'varchar(50)', 'String', 'tagCode', '0', '0', '1', '1', NULL, '1', '1', 'EQ', 'input', '', 3, 'admin', '2022-10-09 09:48:10', '', '2022-10-09 09:49:33');
...
INSERT INTO `sys_config` VALUES (5, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 'admin', '2022-04-22 09:21:16', 'admin', '2022-09-22 12:38:23', '是否开启注册用户功能（true开启，false关闭）');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 101, 'admin', 'ADMIN', '00', 'devzyh@foxmail.com', '18888888888', '0', '/file/avatar/2022/04/27/blob_20220427184129A001.jpeg', '$2a$10$uXTC6to4QjEFCFmXAQcEpOPzoyrlrmOiKfE.thQx3qqYb6ETggb7G', '0', '0', '127.0.0.1', '2022-10-10 21:12:21', 'admin', '2022-04-22 09:21:16', '', '2022-10-10 21:12:22', '系统管理');
